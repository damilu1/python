...
plt.xticks(range, _xticks_labels, rotation, FontProperties=my_font)   #设置x轴刻度（刻度的范围，刻度的标签，刻度的旋转度数，设置中文字体）
plt.text(x, y, string, fontsize, color, alpha)  #添加水印（水印左下角坐标，水印内容，字体格式，透明度）
